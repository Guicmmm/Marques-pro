...
def api_football_fixtures(
    ...
    # Nunca deixar o frontend mandar somente 1 dia.
    search_days = int(
        clamp(
            parse_num(
                days,
...
def get_fixtures(
    ...
    espn_data = deduplicate_fixtures(
        espn_data
    )

    print(
        f"[FIXTURES] ESPN encontrou "
